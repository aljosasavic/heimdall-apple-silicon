...
> This is the original upstream README from grimler's Heimdall, preserved for attribution.
> See the repository root `README.md` for the Apple Silicon fork and flashing guide.
